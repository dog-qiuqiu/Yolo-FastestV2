...
* Picture test
  ```
  python3 test.py --data data/coco.data --weights modelzoo/coco2017-0.241078ap-model.pth --img img/000139.png
  ```
![image](https://github.com/dog-qiuqiu/Yolo-FastestV2/blob/main/img/000139_result.png)
## How to train
