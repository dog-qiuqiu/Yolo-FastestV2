...
## How to train
### Building data sets
* The format of the data set is the same as that of Darknet Yolo. Each image corresponds to a TXT label file. The label format is also based on Darknet Yolo's data set label format: "category cx cy wh", where category is the category subscript, cx, cy are the coordinates of the center point of the normalized label box, and w, h are the normalized label box The width and height, TXT label file content example:
```
